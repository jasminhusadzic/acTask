...
<div class="row">
    <!-- Phone -->
    <div v-for="component in formData" v-bind:key="component.id" v-if="component.component=='phone'" v-bind:id="component.name" class="form-group"  v-bind:class="dynamicClass(component)">
